...
A construção de modelos implícitos da função de transição ou a sua composição analítica a partir dos componentes de um dado diagrama Machinations são possíveis direções de investigação para estudos futuros.
